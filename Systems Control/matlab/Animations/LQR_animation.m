...
L  = 0.20;        % pendulum length 
y0 = -0.10;       % pivot height

% Draw figure 
fig = figure('Color','w','Name','LQR Pendulum Animation');
axis equal
...
% Actuator
magnet_y = y0 + L + 0.05;
rectangle('Position',[-0.06 magnet_y 0.12 0.03],'Curvature',0.2,'FaceColor',[0.3 0.3 0.3]);
