...
class Grid:
    ...
    def create_grid(self):
        ...
        if self.initial_target_pos is None:
            ...
            target_location = self.tiles[self.initial_target_pos[0]][
                self.initial_target_pos[1]
            ]
        ...
        if self.initial_agent_pos is None:
            ...
            agent_location = self.tiles[self.initial_agent_pos[0]][
                self.initial_agent_pos[1]
            ]
